...
arq01 <- read.table ("C:/AulaDataMining/DADOS_Papercsv_1.csv", sep=";", row.names=1 , header=T)
fix(arq01)
...
# Padronizar = valor da coluna - media da coluna / desvio padrão
# Esta técnica permite comparar valores com unidades diferentes (metros, km, etc)
...
write.table(file='C:/AulaDataMining/Paises_cluster.csv',matriz, sep=';',dec=',')
